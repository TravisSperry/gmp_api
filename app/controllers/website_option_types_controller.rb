class WebsiteOptionTypesController < ApplicationController
  ...
  before_action :set_website_option_type, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @website_option_type.save
        format.html { redirect_to @website_option_type, notice: 'Website option type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @website_option_type.update(website_option_type_params)
        format.html { redirect_to @website_option_type, notice: 'Website option type was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to website_option_types_url, notice: 'Website option type was successfully destroyed.' }
